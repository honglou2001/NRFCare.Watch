...
public class BDTransUtil {
	...
	public static void main(String[] args) {
		//113.987915,22.5853634
		double[] bd=wgs2bd(22.65151,113.86091);
		System.out.println("gps转百度:"+String.valueOf(bd[1]).substring(0, 9)+","+String.valueOf(bd[0]).substring(0, 9));
		double[] gcj=wgs2gcj(22.590736,113.97985);
		System.out.println("gps转高德："+String.valueOf(gcj[1]).substring(0, 9)+","+String.valueOf(gcj[0]).substring(0, 9));
		double[] gcj2bd=gcj2bd(22.5853634,113.987915);
		System.out.println("高德转百度:"+String.valueOf(gcj2bd[1]).substring(0, 9)+","+String.valueOf(gcj2bd[0]).substring(0, 9));
		double[] bd2gcj=bd2gcj(22.594056,113.99127);
		System.out.println("百度转高德:"+String.valueOf(bd2gcj[1]).substring(0, 9)+","+String.valueOf(bd2gcj[0]).substring(0, 9));	    
	}
}
