...
//				,0x00,0x00,0x00,0x01,(byte)0xf4,0x01};
		...
		byte[] aa = {0x24,0x24,0x00,0x12,0x30,0x02,0x00,0x00,0x00,0x00,0x05,0x71,0x09,0x31};   //8929
		//byte[] aa = {0x24,0x24,0x00,0x11,0x30,0x02,0x00,0x00,0x00,0x00,0x01,0x00,0x01};   //3B30
...
//		result[1] = (byte)((unsignedValue >> 8) & 0xFF);
//		result[0] = (byte)(unsignedValue & 0xFF);
		...
		String strCacCrc = byteToArray(result);
		System.out.println(strCacCrc);
	}
}
